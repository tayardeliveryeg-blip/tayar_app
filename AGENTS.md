# AGENTS.md — تطبيق طيار (Tayar)

هذا الملف بيدي لأي جلسة Codex سياق سريع عن المشروع قبل ما تبدأ تعدّل فيه.
...
⚠️ **لو الجلسة الحالية (Codex) معندهاش Flutter SDK متاح فعليًا في
